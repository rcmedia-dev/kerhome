          ...
          <div className="w-[80%]">
            {!selectionMode ? (
              <Link
                ...
                className="w-full bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-4 rounded-button text-center transition-all duration-300 flex items-center justify-center gap-2 group/btn shadow-sm text-sm cursor-pointer"
              >
